...
def generate_imgs(a, b, ab_gen, ba_gen, samples_path, epoch=0, str_epoch='ok'):
    ab_gen.eval()
    ba_gen.eval()
    ...
    vutils.save_image(b_imgs_, os.path.join(samples_path, str_epoch + '_b2a_' + str(epoch) + '.png'))
